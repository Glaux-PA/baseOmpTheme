					...
					{if $currentContext}
						...
						<fieldset class="consent">
							{if $currentContext->getData('privacyStatement')}
								...
								<div class="fields">
									<div class="optin optin-privacy form-check input-group-g">
										<input class="form-check-input" type="checkbox" name="privacyConsent" value="1"{if $privacyConsent} checked="checked"{/if}>
							...
							<div class="fields">
								<div class="optin optin-email form-check input-group-g">
									<input class="form-check-input" type="checkbox" name="emailConsent" value="1"{if $emailConsent} checked="checked"{/if}>
									<label class="form-check-label">
						...
						{if $userCanRegisterReviewer}
							<fieldset class="reviewer">
								...
								{/if}
								<div class="fields">
									<div id="reviewerOptinGroup" class="optin form-check input-group-g">
										{foreach from=$reviewerUserGroups[$contextId] item=userGroup}
											{if $userGroup->getPermitSelfRegistration()}
												{assign var="userGroupId" value=$userGroup->getId()}
												<input class="form-check-input" type="checkbox" name="reviewerGroup[{$userGroupId}]" value="1"{if in_array($userGroupId, $userGroupIds)} checked="checked"{/if}>
												<label class="form-check-label">
									...
									<div id="reviewerInterests" class="reviewer_interests form-check input-group-g">
										<input class="form-check-input" type="text" name="interests" id="interests" value="{$interests|default:""|escape}">
										<label class="form-check-label">
											<span class="label">
